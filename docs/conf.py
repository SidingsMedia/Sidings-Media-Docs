...
project = 'Sidings Media Documentation'
...
htmlhelp_basename = 'SidingsMediaDocs'
...
latex_documents = [
    (master_doc, 'SidingsMediaDocs.tex', 'Sidings Media Documentation',
     'Sidings Media Team', 'manual'),
]
